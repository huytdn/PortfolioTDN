          ...
          <div className="flex flex-col gap-12">
            ...
            <FadeIn delay={400}>
              <button
                ...
                className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-white text-black text-base font-medium hover:bg-white/90 transition-all duration-300 w-fit group"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-white/70 leading-relaxed">
                        Specialized in building scalab
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                  ...
                  <p className="text-sm text-white/70 leading-relaxed">
                    Optimizing for speed and efficiency i
                  </p>
                </div>
              </div>
