        ...
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/60 max-w-2xl mx-auto">
              Have a project in mind? Let's discuss how we can brong your ideas
              to life.
            </p>
          </div>
        </FadeIn>
          ...
          <FadeIn delay={200}>
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="group relative bg-white/5 border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <a
                        ...
                        className="text-white hover:text-[#a8ff8ds] transition-colors font-medium"
                      >
                        {PERSONAL_INFO.email}
                      </a>
                    </div>
